...
public class Draw {
  ...
  public void game(Graphics g, Game game) {
    game.draw(g, this.theme, this.windowSize, this.gridTile);
    if (game.getPaused()) {
      this.drawRectangle(g, 6, 9, 18, 12, this.theme.getMenuColor());
      this.drawButton(g, "Continue!", 8, 11, 14, 3);
      this.drawButton(g, "Main Menu!", 8, 16, 14, 3);
